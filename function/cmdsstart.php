...
$videoURLStart = "https://t.me/PremiumAccount_BD/2287";


if (preg_match('/^(\/start|\.start|!start)/', $text)) {
    if (in_array($userId, $freeusers)) {
        $caption = "𝗪𝗲𝗹𝗰𝗼𝗺𝗲 <code>@$username</code> 𝘁𝗼 CyberOrbitCHK 💖
        ...
        'inline_keyboard' => [
            [
                             ['text' => '𝙂𝘼𝙏𝙀𝙒𝘼𝙔𝙎', 'callback_data' => 'gates'],
                                 ...
                                 [
                                 ['text' => '@It_MrVirus', 'callback_data' => 'channel'],
                             ],
        ]
    ]);

    $caption = "Welcome To CyberOrbitCHK. Buy The Plan First.  /price 
